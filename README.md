...
| [hood-ai-trading-agent](https://github.com/brooksmoore/hood-ai-trading-agent) | LLM reasoning on small-cap SEC filings with a forward-only calibration gate before any live decision | Paper, out-of-sample clock running |
| [btc-kalshi-contract-trader](https://github.com/brooksmoore/btc-kalshi-contract-trader) | Short-horizon BTC event-contract trader; measurement-first, cost-honest maker-first paper strategy with a pre-registered kill test | Paper, measurement phase |
...
| [kalshi-market-maker](https://github.com/brooksmoore/kalshi-market-maker) | Weather-market trader, retired by the pre-committed test described above | Retired, archived (verdict in repo) |
...
*Written July 2026 (updated as the fleet grows). Everything above is verifiable in the repos' commit histories, test suites, and audit ledgers. Two coordination and research repos run privately and are noted without links.*
